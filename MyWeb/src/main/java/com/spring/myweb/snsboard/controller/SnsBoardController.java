...
import com.spring.myweb.snsboard.dto.SnsBoardDetailDTO;
...
//		mv.addObject("name", "value");
	...
	*/
	...
	public ResponseEntity<?> download(@PathVariable String fileLoca, 
	  ...
	  public ResponseEntity<SnsBoardDetailDTO> getModal(@PathVariable int bno) {
	      System.out.println("/content/getModal: int bno : " + bno);
